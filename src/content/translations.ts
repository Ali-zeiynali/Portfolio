...
export const translations = {
            ...
            cards: [
                {
                    ...
                    description: 'I build web products end-to-end with a backend-first mindset: robust Python services, clean APIs, and maintainable Vue.js interfaces.',
                    stackTitle: 'Core stack:',
                },
                {
                    title: 'Practical DevOps',
                    description: 'I can containerize apps with Docker, configure Linux servers, and handle deployment setup for stable releases. My DevOps knowledge is practical and focused on delivery.',
    ...
    fa: {
        ...
        hero: {
            ...
            intro: 'تمرکز من روی ساخت بک‌اندهای قابل‌اعتماد با Python و تجربه‌های سریع و تمیز در فرانت‌اند با Vue.js است.',
        },
        expertise: {
            title: 'تخصص‌ها',
            cards: [
                {
                    ...
                    description: 'محصول‌های وب را با نگاه بک‌اند محور توسعه می‌دهم؛ از سرویس‌های پایدار Python و APIهای تمیز تا رابط‌های قابل نگهداری با Vue.js.',
                    stackTitle: 'پشته اصلی:',
                },
                {
                    title: 'DevOps کاربردی',
                    description: 'در حد راه‌اندازی عملیاتی، کانتینرسازی با Docker، تنظیم سرورهای Linux و استقرار پروژه را انجام می‌دهم.',
                    stackTitle: 'ابزارهای مورد استفاده:',
                },
                {
                    title: 'خلاصه تجربه',
                    description: 'سطح تجربه حرفه‌ای در مهارت‌های کلیدی بک‌اند، فرانت‌اند و ابزارهای توسعه.',
            ...
            items: [
                {
                    ...
                    location: 'دورکار',
                    description: 'معماری بک‌اند با Python، طراحی API، پیاده‌سازی فرانت‌اند با Vue.js و تحویل قابلیت‌ها.',
                },
                {
                    date: '۲۰۲۰ تا ۲۰۲۲',
                    role: 'مهندس فول‌استک',
                ...
                },
                {
                    ...
                    location: 'هاوایی',
                    description: 'توسعه قابلیت‌ها، یکپارچه‌سازی API و نگهداری کد.',
                },
                {
                    date: '۲۰۲۰',
                    role: 'کارآموز تحلیل داده',
                    location: 'توکیو',
                    description: 'تحلیل داده، گزارش‌گیری و بهینه‌سازی فرایندها با ابزارهای Python.',
                },
            ],
        },
        projects: {
        ...
        contact: {
            title: 'ارتباط',
            subtitle: 'فعلاً بهترین راه ارتباط، ایمیل است.',
